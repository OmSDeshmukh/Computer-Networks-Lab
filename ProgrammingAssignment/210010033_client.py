...
# function to break connection when client quits
...
# function to update client_details dictionary when new client joins
...
# function to update client_details dictionary when a client leaves
...
# function to handle when client wants to communicate with another client
...
# function to handle video choices
...
# function to handle JSNO messages sent from server
...
# function to handle buffer messages received while watching videos
